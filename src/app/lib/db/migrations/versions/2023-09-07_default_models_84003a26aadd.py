...
def schema_upgrades():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["service_id"],
            ["business_product.id"],
            name=op.f("fk_tscm_check_service_id_business_product"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["vendor_id"], ["vendor.id"], name=op.f("fk_tscm_check_vendor_id_vendor"), ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name=op.f("fk_cpe_product_configuration_id_product_configuration"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["service_id"], ["business_product.id"], name=op.f("fk_cpe_service_id_business_product"), ondelete="CASCADE"
        ),
